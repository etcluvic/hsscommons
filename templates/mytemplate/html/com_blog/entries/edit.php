...
Pathway::append(
	($this->entry->isNew() ? Lang::txt('COM_BLOG_NEW') : Lang::txt('JACTION_EDIT')),
	$this->entry->link('edit')
);

Document::setTitle(Lang::txt('COM_BLOG') . ': ' . ($this->entry->isNew() ? Lang::txt('COM_BLOG_NEW') : Lang::txt('JACTION_EDIT')));
...
<header id="content-header">
	<h2><?php echo Lang::txt('COM_BLOG') . ': ' . ($this->entry->isNew() ? Lang::txt('COM_BLOG_NEW') : Lang::txt('JACTION_EDIT')); ?></h2>
