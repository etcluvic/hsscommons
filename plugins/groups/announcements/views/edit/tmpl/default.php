		...
		<fieldset>
			...
			<div class="form-group">
				<label for="field_content">
					...
					<?php echo $this->editor('fields[content]', $this->escape(stripslashes($this->announcement->get('content'))), 35, 5, 'field_content', array('class' => 'form-control no-footer')); ?>
				</label>
			</div>

			<iframe src="/file" style="width: 100%; height: 200px;"></iframe>
