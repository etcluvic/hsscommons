...
<section class="main section">
	...
	<?php } else if ($this->config->get('access-plugin') == 'members') { ?>
		<aside class="aside">
			<div class="container">
				<p><strong><?php echo Lang::txt('PLG_GROUPS_FORUM_WHAT_IS_STICKY'); ?></strong><br />
				<?php echo Lang::txt('PLG_GROUPS_FORUM_STICKY_EXPLANATION'); ?></p>

				<p><strong><?php echo Lang::txt('PLG_GROUPS_FORUM_WHAT_IS_LOCKING'); ?></strong><br />
				<?php echo Lang::txt('PLG_GROUPS_FORUM_LOCKING_EXPLANATION'); ?></p>
			</div>
		</aside><!-- /.aside -->
	<?php } ?>
