	...
	<div class="subject">
		...
		<div class="share" style="padding-top: 10px; padding-bottom: 10px; display: flex; flex-wrap: wrap;">
			...
			<div style="display: flex; flex-wrap: wrap; gap: 5px;">
				...
				<a href="<?php echo 'http://twitter.com/intent/tweet?text=' . urlencode(Lang::txt('COM_BLOG_SHARE_VIEWING', stripslashes($title))) . '&url=' . $url; ?>" target="_blank" style="border: none;">
