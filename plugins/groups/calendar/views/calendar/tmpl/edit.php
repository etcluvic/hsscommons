		...
		<form name="editevent" action="<?php echo Route::url('index.php?option='.$this->option.'&cn='.$this->group->cn.'&active=calendar'); ?>" method="post" id="hubForm" class="full">
			<fieldset>
				...
				<label for="event_title">
					...
					<input type="text" name="event[title]" id="event_title" value="<?php echo $this->escape($this->event->get('title')); ?>" required/>
				</label>
				...
				<label for="event_content">
					...
					<?php echo App::get('editor')->display('content', $this->event->get('content'), '', '', 10, 15, false, 'event_content', null, null, array('class' => 'minimal no-footer')); ?>
				...
				<fieldset>
					...
					<label for="event_start">
						...
						<div class="input-group">
							<input type="text" name="event[publish_up]" id="event_start_date" value="<?php echo $this->escape($publish_up_date); ?>" placeholder="mm/dd/yyyy" class="no-legacy-placeholder-support" required/>
